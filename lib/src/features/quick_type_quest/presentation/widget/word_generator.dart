...
enum WordListType { top100, top200, top500, top1000 }
...
class WordGenerator {
  ...
  String nextWord() {
    if (WordGenerator._words.isEmpty) {
      throw StateError('Word list is not initialized');
    }
    final index = random.nextInt(WordGenerator._words.length);
