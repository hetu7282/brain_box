...
List<Sprite> pteraFrames = [
  Sprite()
    ..imagePath = Assets.assetsImageDinosaurPteraPtera1
    ..imageHeight = 80
    ..imageWidth = 92,
  Sprite()
    ..imagePath = Assets.assetsImageDinosaurPteraPtera2
    ..imageHeight = 80
    ..imageWidth = 92,
];
...
class Ptera extends GameObject {
  ...
  @override
  Widget render() {
    return Image.asset(pteraFrames[frame].imagePath, gaplessPlayback: true);
  }
