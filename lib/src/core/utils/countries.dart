...
Future<Country?> showCountryDialog(BuildContext context) async {
  Country? value = await showDialog(
    context: context,
...
class _CountryListDialogState extends State<CountryListDialog> {
  ...
  ValueNotifier<List<Country>> countryList = ValueNotifier(countries);
                          ...
                          CustomFormField(
                            ...
                            prefixIcon: Padding(
                              ...
                              child: Image.asset(
                                ...
                                height: isTablet ? 17.px : 15.px,
                                width: isTablet ? 17.px : 15.px,
                              ),
                            ),
                            contentPadding: EdgeInsets.symmetric(
                              horizontal: 15,
                            ),
                            onChange: (value) => _onSearchChanged(context),
                          ),
                          GapH(1.h),
                          Expanded(
